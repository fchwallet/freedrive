# FOCP3V1 Protocol Specification
...
<sup>2. when some fields with 1 byte asscii: '\x00' , which means paddings </sup>   
...
<sup>3. when length field is \x00 means not update,  length is \x01 and the data is ascii \x00 means clear all data of the field.</sup>
